...
export default function Main() {
 ...
 const handleRadioClick = () =>{setpage({value:"Status"})};;
 const handlePhoneClick = () =>{setpage({value:"Call"})};;
 const handleMessagesClick = () =>{setpage({value:"Message"})};
 ...
 const topIcons = [
  ...
  { icon: RadioButtonCheckedIcon, label: 'Status', onClick: handleRadioClick },
 ];
